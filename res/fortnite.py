...
try:
    ...
    print(e)
    print(Fore.RED + f'[-] ' + Fore.RESET + 'Failed to import 1 or more modules. Run "INSTALL.bat')
    exit()
...
print(f'\n The best free lobby bot Created for P-Denny Gaming for {patch}.\n')
